...
## Finance
- [ ] Portfolio optimtisation
- [ ] How economic factors affect retuerns
- [ ] PCA for risk management and asset pricing
- [ ] Risk management
- [ ] Black Scholes option pricing
- [ ] Taking partial derivatives to find optimal weights for portfolio optimtisation
...
- [ ] Quote stuffing
- [ ] Cointegration
- [ ] Fund teardown (what they invest in, how they raise capital, performance in terms of IRR, MOIC, recent deals)
- [ ] Comparable fund deck (build your own mock PE pitch deck using public comps or 13F data)
- [ ] Deal sourcing map (pick a niche and build a list of 20+ potential acquisition targets)
- [ ] Investor memo (pick a company and write a 1-page investment memo, include business model, risks, exit potential, and valuation)
...
- [ ] Carry trade
- [ ] Overnight drift
- [ ] 3 financial statements (income statement, cashflow statement, balance sheet) which financial statement is best for analysing company's value
- [ ] EPS neutral
- [ ] Basis points (bips) = 1/100 * 1%, 50bips = 0.5%
...
- [ ] CS50's introduction to programming with python OpenSourceWare
...
- [ ] 12 week year book
- [ ] MIT OpenSourceWare Jake Xia 2015
- [ ] cybergeekgyan github
